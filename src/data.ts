...
export const personalInfo = {
  ...
  github: 'https://github.com/gabrielaespin',
};
...
export const projects = [
  {
    ...
    description: 'Projeto web desenvolvido com foco em presença digital, design moderno e experiência do usuário, oferecendo uma vitrine profissional online.',
    activities: [
  ...
  },
  {
    ...
    description: 'Empresa de tecnologia idealizada e fundada para oferecer soluções digitais modernas para empresas e profissionais que buscam transformação digital.',
    activities: [
    ...
    technologies: ['HTML', 'CSS', 'JavaScript', 'React', 'WordPress', 'Elementor'],
    color: 'from-indigo-500 to-purple-500',
    initials: 'ZS',
  },
  {
    name: 'Portal da Prefeitura de Ferraz de Vasconcelos',
    category: 'Projeto Institucional',
    description: 'Participação em atividades relacionadas ao gerenciamento e atualização do portal institucional da Prefeitura Municipal de Ferraz de Vasconcelos.',
    activities: [
      'Atualização de conteúdos institucionais',
      'Organização e estruturação de páginas',
      'Suporte na manutenção do portal',
      'Gerenciamento de informações públicas',
    ],
    technologies: ['WordPress', 'Elementor', 'Administração Web'],
